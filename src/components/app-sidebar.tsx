...
const GROUPS: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Tecnicos", icon: UserSquare2, roles: ["administrador"], pendiente: true },
      { title: "Inventario", icon: Package, roles: ["administrador", "inventario"], pendiente: true },
      { title: "Compras", icon: ShoppingCart, roles: ["administrador", "inventario"], pendiente: true },
      { title: "Proveedores", icon: Truck, roles: ["administrador", "inventario"], pendiente: true },
